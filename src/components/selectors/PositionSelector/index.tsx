...
interface PositionSelectorState {
  value: string;
  options: [];
}

const defaultProps: PositionSelectorProps = { debounceTimeOut: 400 };

class PositionSelector extends PureComponent<PositionSelectorProps, PositionSelectorState> {
  //
  // static defaultProps: PositionSelectorProps = { debounceTimeOut: 800 };

  constructor(props: PositionSelectorProps) {
    super(props);
    this.state = {
      value: props.value,
      options: [],
...
PositionSelector.defaultProps = defaultProps;
